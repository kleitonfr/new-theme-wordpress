...
<div class="wp-block-group pmc-events has-white-color has-ticker-gradient-gradient-background has-text-color has-background">
	<!-- wp:html -->
	<div class="pmc-events__inner">
		<p class="pmc-events__label">
			<svg class="pmc-events__icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">
